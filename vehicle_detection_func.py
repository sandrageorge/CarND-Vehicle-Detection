...
def single_img_features(img, color_space='RGB', spatial_size=(32, 32),
    ...
    if hist_feat == True:
        hist_features = color_hist(feature_image, nbins=int(hist_bins))
...
def find_cars(image, parameters=parameters, X_scaler=X_scaler, svc=svc):
    ...
    plt.savefig("writeup_images/draw_image.jpg")
    plt.title('Car Positions')
    # plt.subplot(132)
    plt.imshow(heatmap, cmap='hot')
    plt.savefig("writeup_images/heatmap.jpg")
    plt.title('Heat Map')
    # plt.subplot(131)
    plt.imshow(window_image)
    plt.savefig("writeup_images/window_image.jpg")
    plt.title('Windows')
